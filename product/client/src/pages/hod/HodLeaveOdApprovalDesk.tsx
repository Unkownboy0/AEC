  ...
  return (
    <div className="space-y-6">
      ...
      {showDetailModal && selectedRequest && (() => {
        ...
        return (
          <div className="fixed inset-0 z-50 bg-slate-900/60 flex items-end justify-center overflow-hidden p-0 sm:items-center sm:p-4">
            <div className="flex max-h-[calc(100dvh-var(--safe-area-top))] w-full max-w-3xl flex-col overflow-hidden rounded-t-2xl border border-slate-200 bg-white dark:border-slate-700 dark:bg-slate-800 sm:max-h-[90vh] sm:rounded-2xl">
              ...
              {/* Action Footer */}
              <div className="flex shrink-0 flex-col gap-3 border-t border-slate-200 bg-slate-50 p-4 pb-[calc(1rem+var(--safe-area-bottom))] dark:border-slate-700 dark:bg-slate-900/50 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between sm:pb-4">
                <button
