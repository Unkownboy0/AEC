...
export const WorkspaceSwitcher: React.FC = () => {
  ...
  const handleSelectWorkspace = async (ws: string) => {
    ...
    try {
      ...
      // Route based on newly active workspace
      const norm = ws.toUpperCase();
      if (norm.includes('STUDENT')) navigate('/student/dashboard');
      else if (norm.includes('HOD')) navigate('/hod/dashboard');
      else if (norm.includes('PRINCIPAL')) navigate('/principal/dashboard');
      else if (norm.includes('VP')) navigate('/vp/dashboard');
      else if (norm.includes('DEAN')) navigate('/academic-dean/dashboard');
