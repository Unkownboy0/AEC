  ...
  const getQuickLinks = () => {
    ...
    if (role.includes('STUDENT')) {
      return [
        ...
        { label: 'Apply Leave / OD', path: '/student/requests', icon: <FileCheck className="w-4 h-4 text-primary" /> },
  ...
  return (
    <>
      <button
        ...
        type="button"
        className="flex items-center gap-2 px-3.5 py-2 bg-surface-soft hover:bg-surface border border-border rounded-xl text-xs text-text-muted hover:text-text-primary transition-colors w-36 sm:w-64 shadow-xs"
      >
