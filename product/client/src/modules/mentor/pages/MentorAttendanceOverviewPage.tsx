  ...
  const columns: Column<any>[] = [
    {
      ...
      header: 'Roll No',
      sortable: true,
      render: (st) => <span className="font-mono font-bold text-xs">{st.admissionNo || st.rollNo || st.regNo}</span>,
    },
    {
      key: 'name',
      header: 'Mentee Name',
    ...
    },
    {
      ...
      render: (st) => <span className="text-xs">{st.attendedClasses ?? '—'} / {st.totalClasses ?? '—'}</span>,
    },
    {
