      ...
      <div className="bg-surface border border-border rounded-2xl p-5 shadow-sm">
        ...
        {selectedFac && (
          <div className="mt-4 p-3 rounded-xl bg-primary/5 border border-primary/20 text-sm">
            ...
            <span className="text-text-secondary">{selectedFac.totalPeriods} allocated periods · {selectedFac.busySlots ?? 0} busy · {selectedFac.availableSlots ?? 48} free timetable slots</span>
          </div>
        )}
      </div>
