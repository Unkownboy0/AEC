...
export const ROLE_BOTTOM_NAV_CONFIGS: RoleBottomNavConfig[] = [
  ...
  { role: 'ACCOUNTS_STAFF', tabs: ['accountant-dashboard','accountant-fee-collection','accountant-transactions','accountant-daily-collection'] },
  { role: 'ACCOUNTANT', tabs: ['accountant-dashboard','accountant-fee-collection','accountant-transactions','accountant-daily-collection'] },
  { role: 'ACCOUNTS_OFFICER', tabs: ['ao-dashboard','ao-collection-overview','ao-closing-approvals','ao-reconciliation'] },
];
