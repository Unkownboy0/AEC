...
export declare class UsersController {
    ...
    commitImport: (req: Request, res: Response, next: NextFunction) => Promise<void>;
    previewImportFile: (req: Request, res: Response, next: NextFunction) => Promise<void>;
    commitImportFile: (req: Request, res: Response, next: NextFunction) => Promise<void>;
