...
const principal_failover_routes_1 = __importDefault(require("./modules/enterprise/principal-failover.routes"));
const circular_engine_routes_1 = __importDefault(require("./modules/enterprise/circular-engine.routes"));
const profile_drilldown_routes_1 = __importDefault(require("./modules/enterprise/profile-drilldown.routes"));
const timeline_routes_1 = __importDefault(require("./modules/enterprise/timeline.routes"));
const phase8_export_routes_1 = __importDefault(require("./modules/enterprise/phase8-export.routes"));
const analytics_routes_1 = __importDefault(require("./modules/enterprise/analytics.routes"));
const phase10_production_routes_1 = __importDefault(require("./modules/enterprise/phase10-production.routes"));
...
app.use('/api/hod/leave-od', student_leave_routes_1.default);
app.use('/api/hod', academic_dean_hod_routes_1.default);
app.use('/api/hod', hod_routes_1.default);
app.use('/api/enterprise/faculty-leave', faculty_leave_routes_1.default);
app.use('/api/faculty/leave', faculty_leave_routes_1.default);
app.use('/api/faculty-leave', faculty_leave_routes_1.default);
app.use('/api/enterprise/principal-failover', principal_failover_routes_1.default);
app.use('/api/enterprise/circulars', circular_engine_routes_1.default);
app.use('/api/enterprise/profile', profile_drilldown_routes_1.default);
app.use('/api/enterprise/timeline', timeline_routes_1.default);
app.use('/api/enterprise/analytics', analytics_routes_1.default);
